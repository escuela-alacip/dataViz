...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Google_Drive_logo.svg/245px-Google_Drive_logo.svg.png" width="200">
...
<img src="https://aem.dropbox.com/cms/content/dam/dropbox/www/en-us/branding/app-dropbox-windows@2x.png" width="200">


* Suba los archivos a Dropbox.
* Copiar el link de dropbox. 


Lea el archivo en Excel que tiene en Dropbox, instale la librería **rio**, y use el link creado. Asegurarse de cambiar el link hacia **dl=1**.
...
Lea el archivo en SPSS que tiene en Dropbox, instale la librería **rio**, y use el link creado. Asegurarse de cambiar el link hacia **dl=1**.
